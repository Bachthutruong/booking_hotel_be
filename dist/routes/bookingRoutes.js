...
router.post('/admin', auth_1.protect, (0, auth_1.authorize)('admin'), bookingController_1.createBookingAdmin);
...
router.patch('/:id/services/deliver', auth_1.protect, (0, auth_1.authorize)('admin'), bookingController_1.markServiceDelivered);
router.patch('/:id/services/deliver-all', auth_1.protect, (0, auth_1.authorize)('admin'), bookingController_1.markAllServicesDelivered);
...
// Admin only
router.put('/:id/status', auth_1.protect, (0, auth_1.authorize)('admin'), bookingController_1.updateBookingStatus);
router.put('/:id/approve', auth_1.protect, (0, auth_1.authorize)('admin'), bookingController_1.approveBooking);
router.put('/:id/checkin', auth_1.protect, (0, auth_1.authorize)('admin'), bookingController_1.checkInBooking);
router.post('/:id/checkout', auth_1.protect, (0, auth_1.authorize)('admin'), bookingController_1.checkoutBooking);
