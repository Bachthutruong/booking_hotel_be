...
// Admin routes
router.get('/admin/all', auth_1.protect, (0, auth_1.authorize)('admin'), roomCategoryController_1.getAllCategories);
router.post('/', auth_1.protect, (0, auth_1.authorize)('admin'), roomCategoryController_1.createCategory);
router.put('/:id', auth_1.protect, (0, auth_1.authorize)('admin'), roomCategoryController_1.updateCategory);
