...
// Admin
router.get('/admin/all', auth_1.protect, (0, auth_1.authorize)('admin'), serviceCategoryController_1.getAllServiceCategories);
router.post('/', auth_1.protect, (0, auth_1.authorize)('admin'), serviceCategoryController_1.createServiceCategory);
router.put('/:id', auth_1.protect, (0, auth_1.authorize)('admin'), serviceCategoryController_1.updateServiceCategory);
